...
import { ShoppingCart, CreditCard, Truck, User, MapPin, ChevronRight, AlertCircle, Check, Trash, Plus, Minus } from 'lucide-react';
...
const CartCheckoutPage = () => {
  ...
  // Fetch cart items and product data on component mount
  useEffect(() => {
        ...
        <>
          <div className="bg-gray-900/60 backdrop-blur-xl rounded-2xl p-6 border border-gray-800/80 shadow-xl shadow-blue-900/20 mb-6">
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center">
                  <div className="text-blue-400 mr-3 font-bold text-xl">B</div>
                  <div>
